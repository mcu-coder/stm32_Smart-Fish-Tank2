...
#define time_MAX                           50
#define time_LEN                           1
#define tempvalue_MAX_RATIO                         1
#define tempvalue_MAX_ADDITION                      10
#define tempvalue_MAX_MIN                           0
#define tempvalue_MAX_MAX                           50
#define tempvalue_MAX_LEN                           1
#define tempvalue_MIN_RATIO                         1
#define tempvalue_MIN_ADDITION                      10
#define tempvalue_MIN_MIN                           0
#define tempvalue_MIN_MAX                           50
#define tempvalue_MIN_LEN                           1
#define waterlevelValue_MAX_RATIO                         100
#define waterlevelValue_MAX_ADDITION                      100
#define waterlevelValue_MAX_MIN                           0
#define waterlevelValue_MAX_MAX                           39
#define waterlevelValue_MAX_LEN                           1
#define waterlevelValue_MIN_RATIO                         100
#define waterlevelValue_MIN_ADDITION                      100
#define waterlevelValue_MIN_MIN                           0
#define waterlevelValue_MIN_MAX                           39
#define waterlevelValue_MIN_LEN                           1
#define turbValue_RATIO                         100
#define turbValue_ADDITION                      100
#define turbValue_MIN                           0
#define turbValue_MAX                           14
#define turbValue_LEN                           1
#define timeValue_RATIO                         5
#define timeValue_ADDITION                      5
#define timeValue_MIN                           0
#define timeValue_MAX                           6
#define timeValue_LEN                           1
#define waterleve_RATIO                         1
#define waterleve_ADDITION                      0
#define waterleve_MIN                           0
#define waterleve_MAX                           3500
#define waterleve_LEN                           2
#define turb_RATIO                         1
#define turb_ADDITION                      0
#define turb_MIN                           0
#define turb_MAX                           2500
#define turb_LEN                           2
...
typedef enum
{
    ...
    EVENT_tempvalue_MAX,
    EVENT_tempvalue_MIN,
    EVENT_waterlevelValue_MAX,
    EVENT_waterlevelValue_MIN,
    EVENT_turbValue,
    EVENT_timeValue,
...
typedef struct {
    ...
    uint32_t valuetemp;
    uint32_t valuetime;
    uint32_t valuetempvalue_MAX;
    uint32_t valuetempvalue_MIN;
    uint32_t valuewaterlevelValue_MAX;
    uint32_t valuewaterlevelValue_MIN;
    uint32_t valueturbValue;
    uint32_t valuetimeValue;
    uint32_t valuewaterleve;
    uint32_t valueturb;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flagtemp:1;
    uint8_t flagtime:1;
    uint8_t flagtempvalue_MAX:1;
    uint8_t flagtempvalue_MIN:1;
    uint8_t flagwaterlevelValue_MAX:1;
    uint8_t flagwaterlevelValue_MIN:1;
    uint8_t flagturbValue:1;
    uint8_t flagtimeValue:1;
    uint8_t flagwaterleve:1;
    uint8_t flagturb:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuetemp;
    uint8_t valuetime;
    uint8_t valuetempvalue_MAX;
    uint8_t valuetempvalue_MIN;
    uint8_t valuewaterlevelValue_MAX;
    uint8_t valuewaterlevelValue_MIN;
    uint8_t valueturbValue;
    uint8_t valuetimeValue;
    uint16_t valuewaterleve;
    uint16_t valueturb;
} devStatus_t;
